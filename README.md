...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
  <img class="w3-image" src="home.jpg"  alt="food" width="1600" height="800">
  <div class="w3-display-middle w3-padding-large w3-black">
    <h1 class="w3-xxxlarge w3-animate-left w3-card-4">"สวนลุงเจิม" </h1>
  </div>
</header>
...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64 w3-card-1" id="about">
    <div class="w3-col m6 w3-padding-large w3-hide-small">
     <img src="slj2.jpg" class="w3-round w3-image w3-hover-opacity" alt="food" width="600" height="750">
    </div>

    <div class="w3-col m6 w3-padding-large w3-card-4 ">
      <h1 class="w3-center w3-animate-left w3-card-4 w3-border w3-hover-red ">สวนลุงเจิม</h1><hr>
      <h5 class="w3-center">ร้านอาหารในสวน </h5>
      <p class="w3-large">สวนลุงเจิม เป็นร้านอาหารที่บรรยากาศอยู่ในสวนมีต้นไม้เป็นธรรมชาติ อาหารมีหลากหลายรูปแบบ และนับได้ว่าราคาถูกหากเทียบกับร้านอื่นๆ รสชาติอร่อย เหมาะสำหรับทุกคน  </P>
<span class="w3-tag w3-red">ต้องลอง !</span> ข้าวลาบสเต็กไก่,กุ้งทอดกระเทียม,ยำปูอัด,น้ำเก๊กฮวยเยลลี่ 
	  </div>
  </div>
  <!-- Menu Section -->
  ...
  <div class="w3-row w3-padding-64 w3-card-2" id="menu">
    <div class="w3-col l6 w3-padding-large w3-text-green">
      ...
      <h4>เวลาเปิดร้าน</h4>
      <p class="w3-text-grey">เปิดบริการทุกวันตั้งแต่เวลา 19.00-24.00</p><br>
...
<div class="w3-display-container mySlides">
  <img src="slj2.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">

  </div>
</div>
<div class="w3-display-container mySlides"> 
  <img src="slj4.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">
  </div>
  
</div>
<div class="w3-display-container mySlides"> 
  <img src="slj5.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">
  </div>
  
</div>
<div class="w3-display-container mySlides"> 
  <img src="slj6.jpg" style="width:100%">
  <div class="w3-display-middle w3-large w3-container w3-padding-16 ">
  </div>
